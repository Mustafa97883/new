...
exports.run = function(client, message, args) {
  ...
  .setDescription(` <@${adı}> adlı kişinini yetkili başvurusunu onayladın.\nOnaylayan yetkili : ${message.author}`)
    ...
    if (!adı) return message.channel.send(`<a:alarm3:823900153831620658> Başvuran kişinin ismini yazmalısınız`).then(m => m.delete({timeout: 10000}))
  message.delete()
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['başvuru-onayla', 'onayla','onay'],
  permLevel: 3
};
