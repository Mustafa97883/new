...
exports.run = function(client, message, args) {
  ...
  if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`:no_entry: Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.`);
	if(!args[0]) return message.channel.send(new Discord.MessageEmbed()
                                          ...
                                          .setDescription(`
                                          > <a:pin:823900118213853184> **• \`!botlist-ayar botekle-kanal #kanal\` => Bot Ekleme Kanalını Ayarlarsınız.**
                                          > <a:pin:823900118213853184>  **• \`!botlist-ayar botlog-kanal #kanal\` Bot Log Kanalını Ayarlarsınız.**
                                          
                                          > <a:pin:823900118213853184> **• \`!botlist-ayar başvurugiden-kanal #kanal\` Başvuru Logunu Ayarlarsınız.**
                                          
                                          > <a:pin:823900118213853184>  **• \`!botlist-ayar yetkili @rol\` Botlist Yetkili Rolünü Ayarlarsınız.**
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['botlistayar','botlistayarla','botlist-yardım'],
  permLevel: 0,
};
