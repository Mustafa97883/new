...
exports.run = async (client, msg, args) => {
  let açıkmı = await data.fetch(`premium.${msg.guild.id}`)
  if(açıkmı) {

// premium açıksa yapılack işlemler buraya

} else { return msg.channel.send(`${msg.author}, bu komut premium bir komuttur. Bu sunucu da premium bulunmamakta.`) }
  let kufur=[  
    ...
    "anasının amında olimpiyat meşalesi yakıp 10 km kostuğumun cocuğu ",
    "Amını taşağını üsten bastırıp ",
    ...
    "küfür ederdim ama anan çok yordu","öyle yan durup şekilli mekilli tişört giyme ananı götünden siker Erol Taş gibi kiraz ağacından kamçı yapar döverim",
    ...
    "Anneni düdüklediğim niye artistlik yapıyorsun",
  ]
